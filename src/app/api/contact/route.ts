  ...
  try {
      ...
      businessEmailResult = await resend.emails.send({
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #0B1E3C; border-bottom: 2px solid #C8A46E; padding-bottom: 10px;">
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tr>
                  ...
                  <td style="padding: 10px; border-bottom: 1px solid #e5e7eb;">
                    <a href="mailto:${email}" style="color: #C8A46E;">${email}</a>
                  </td>
                </tr>
                <tr>
                  <td style="padding: 10px; border-bottom: 1px solid #e5e7eb;"><strong>Phone:</strong></td>
                  <td style="padding: 10px; border-bottom: 1px solid #e5e7eb;">
                    <a href="tel:${phone}" style="color: #C8A46E;">${phone}</a>
                  </td>
                </tr>
                ${service ? `
                <tr>
            ...
            <div style="margin: 20px 0;">
              ...
              <div style="padding: 15px; background-color: #F4F1EC; border-radius: 5px;">
                ${message.replace(/\n/g, '<br>')}
              </div>
            </div>
            ` : ''}
    ...
    try {
      confirmationEmailResult = await resend.emails.send({
        ...
        subject: 'Thank you for contacting Klingeman CPAs',
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <div style="text-align: center; padding: 20px; background-color: #0B1E3C;">
              <h1 style="color: white; margin: 0;">Klingeman CPAs</h1>
            </div>

            <div style="padding: 30px;">
              <h2 style="color: #0B1E3C;">Thank You for Contacting Us!</h2>
              ...
              <div style="margin: 30px 0; padding: 20px; background-color: #F4F1EC; border-radius: 5px;">
                <h3 style="color: #0B1E3C; margin-top: 0;">Your Submission Details:</h3>
              ...
              <div style="margin: 30px 0;">
                <h3 style="color: #0B1E3C;">What Happens Next?</h3>
              ...
              <div style="margin: 30px 0;">
                ...
                <p style="text-align: center;">
                  <a href="tel:9189221019" style="display: inline-block; padding: 12px 30px; background-color: #C8A46E; color: white; text-decoration: none; font-weight: bold;">
                    (918) 922-1019
                  </a>
                </p>
              </div>
            ...
            <div style="padding: 20px; background-color: #F4F1EC; text-align: center; color: #6b7280; font-size: 12px;">
              <p style="margin: 5px 0;">Klingeman CPAs</p>
              <p style="margin: 5px 0;">Former IRS Management | 225+ Years Combined Experience</p>
              <p style="margin: 5px 0;">
                <a href="https://klingemancpas.com" style="color: #C8A46E;">klingemancpas.com</a>
              </p>
            </div>
          </div>
        `,
