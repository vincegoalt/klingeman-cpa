    ...
    <>
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            src="/coffee and tax.jpg"
            alt="Coffee and Tax Background"
            fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                Tulsa's Most
                <span className="block bg-gradient-to-r from-gray-100 to-white bg-clip-text text-transparent">Trusted CPAs</span>
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-gray-400">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>5.0 Rating <span className="text-gray-500">•</span> 100+ Reviews</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-gray-400 to-gray-300 rounded-2xl opacity-10 blur-2xl"></div>
              <div className="relative bg-white rounded-2xl shadow-2xl p-8 lg:p-10">
                <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                  <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 py-2 rounded-full font-bold text-sm shadow-lg border border-gray-700">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center text-gray-800 font-semibold group-hover:text-gray-900">
                      Learn More
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur rounded-xl p-6 shadow-xl">
                  ...
                  <p className="text-gray-700 font-semibold mb-2">{FOUNDER_INFO.title}</p>
