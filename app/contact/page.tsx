        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Contact Your
              <span className="block bg-gradient-to-r from-gray-100 to-white bg-clip-text text-transparent">Tulsa CPA</span>
            </h1>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href={`tel:${BUSINESS_INFO.phoneRaw}`} className="text-gray-700 hover:underline text-lg">
                          {BUSINESS_INFO.phone}
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a href={`mailto:${BUSINESS_INFO.email}`} className="text-gray-700 hover:underline">
                          {BUSINESS_INFO.email}
                        </a>
                      </div>
                    </div>
