        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              Tax & Accounting
              <span className="block text-white">Knowledge Hub</span>
            </h1>
              ...
              {featuredPosts.map((post) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-gray-800 transition">
                      {post.title}
                    </h3>
              ...
              {regularPosts.map((post) => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <span className="bg-gradient-to-r from-blue-100 to-blue-200 text-gray-700 px-3 py-1 rounded-full text-xs font-bold">
                      {post.category}
                    </span>
