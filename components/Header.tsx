      ...
      <div className="bg-gradient-to-r from-blue-900 to-blue-800 text-white py-2">
        <div className="container mx-auto px-4 flex flex-col sm:flex-row justify-between items-center text-sm">
          ...
          <a
            ...
            className="font-bold hover:text-yellow-400 transition flex items-center gap-2 mt-2 sm:mt-0"
          >
        ...
        <nav className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <ul className="hidden lg:flex items-center gap-1">
              ...
              <li>
                <Link href="/es" className="px-3 py-2 text-gray-700 hover:text-blue-600 transition font-medium flex items-center gap-1">
